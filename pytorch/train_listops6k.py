...
from experiment_utils.generate_data import listops6k_loader
...
# Load data
###############################################################################
tr_iter = listops6k_loader('train', path=args.data, task_name=args.dataset, batch_size=args.batch_size,
                                    tgt_len=args.tgt_len, device=device)
va_iter = listops6k_loader('val', path=args.data, task_name=args.dataset, batch_size=args.batch_size,
                                    tgt_len=args.tgt_len, device=device)
...
#                     raise(NotImplementedError)
                prev_data = prev_data[-args.mem_backprop_depth:] + [data_]
                prev_target = prev_target[-args.mem_backprop_depth:] + [target_]
